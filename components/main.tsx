                ...
                <div className="lg:px-4 lg:mt-12 ">
                  <div className="mt-6 text-gray-800  ">
                    {language && (
                      <div>
                        <p className="mb-4">
                          한번 시도로 안되면 두번 세번 시도하는 AI 엔지니어
                          개발자입니다. 컴퓨터 공학과를 전공하였으며, AI 뿐만
                          아니라 여러 분야 또한 배우고 도전하는것을 좋아합니다.
                        </p>
                        <p className="mb-4">
                    ...
                    {!language && (
                      <div>
                        <p className="mb-4">
                          I&apos;m a AI Engineer who tries twice or
                          three times to achieve results if it doesn&apos;t work
                          out once. I majored in computer engineering&apos; and I
                          like to learn various fields as well as AI.
                        </p>
                        <p className="mb-4">
